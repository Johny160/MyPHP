    ...
    if(isset($_POST["submit"]) && isset($_FILES["image"])){
        ...
        if ($error === 0){
            if ($image_size > 9000000){
                Url::redirectUrl("/www1/errors/error-page.php?error_text=Váš soubor je příliš veliký");
            } else {
                ...
                if(in_array($image_extension_lower_case, $allowed_extensions)){
                    ...
                    if(Image::insertImage($connection, $user_id, $new_image_name)){
                        Url::redirectUrl("/www1/admin/photos.php");
                    }

                } else {
                    Url::redirectUrl("/www1/errors/error-page.php?error_text=Koncovka vašeho souboru není povolená");
                }
     
            }

        } else {
            Url::redirectUrl("/www1/errors/error-page.php?error_text=Nahrání obrázku se bohužel nepodařilo");
        }

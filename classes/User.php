    ...
    public static function authentication($connection, $log_email, $log_password) {
        ...
        try {
            if($stmt->execute()) {
                ...
                throw new Exception("Autentikácia sa nepodarila.");
            }
        } catch (Exception $e) {
    ...
    public static function getUserId($connection, $email){
        ...
        try {
            if($stmt->execute()){
                ...
                throw new Exception("Získanie užívateľského ID sa nepodarila.");
            }
        } catch (Exception $e) {
    ...
    public static function getUserRole($connection, $id){
        ...
        try {
            if($stmt->execute()){
                ...
                throw new Exception("Získanie uživateľskej role sa nepodarilo.");
            }
        } catch (Exception $e) {
